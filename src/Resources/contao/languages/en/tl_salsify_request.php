...
$GLOBALS['TL_LANG']['tl_salsify_request']['source_folder']            = array('Source Folder', 'The folder where our Salsify files will be published. This folder will be polled for updates.');
