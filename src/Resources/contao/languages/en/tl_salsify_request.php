...
$GLOBALS['TL_LANG']['tl_salsify_request']['source_folder']            = array('Source Folder', 'Enter the folder location for where to poll for updates. Assume we start in \'public_html/files\'');
