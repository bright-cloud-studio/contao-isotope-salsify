...
(
    ...
    'palettes' => array
    (
        'default'                     => '{salsify_product_legend}, product_name, product_sku, isotope_product_type, email;{internal_details_legend}, isotope_product_type_linked, import_status, last_update;'
    ),
