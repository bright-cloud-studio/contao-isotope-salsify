...
(
    ...
    (
        ...
        'is_category' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_salsify_attribute']['is_category'],
            'inputType'               => 'checkbox',
            'default'				  => '',
            'eval'                    => array('multiple'=>false, 'chosen'=>true, 'tl_class'=>'w50'),
            'sql'                     => "char(1) NOT NULL default ''"
